...
#define MODULE_INITIALIZATION_FUNC(name) void name(Module* module)
...
namespace emerald {
    ...
    public:
        using ModuleInitialization = std::function<void(Module*)>;
        ...
        static void init_module(Module* module);
